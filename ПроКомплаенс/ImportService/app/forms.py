...
class AddFileForm(FlaskForm):
    fileContents = FileField('Выберите файл csv',validators=[FileRequired(), FileAllowed(['csv'], message="Файл содержит недопустимые символы в названии или неверное расширение!")])
